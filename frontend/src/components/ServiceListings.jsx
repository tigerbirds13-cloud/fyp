            ...
            <div key={service.id} className="service-card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <MoneyIcon />
                  <span style={{ color: 'white', fontSize: 14 }}>{service.pay}</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <LocationIcon />
                  <span style={{ color: 'white', fontSize: 14 }}>{service.location}</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <PeopleIcon />
                  <span style={{ color: 'white', fontSize: 14 }}>{service.applicants} applicants</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <CalendarIcon />
                  <span style={{ color: service.status === 'Active' ? '#22c55e' : '#6b7280', fontSize: 14 }}>{service.status}</span>
                </div>
              </div>
